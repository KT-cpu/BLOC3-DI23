...
<head>
    ...
    <link rel="stylesheet" href="AccueilInvites.css">
...
<body id="main">
    ...
    <div class="header">
        <div class="icon">
            <a href="http://127.0.0.1:5500/AccueilInvites.html"><img src="..\..\..\Ressources Cubes\LogoBloc3.png" class="iconfoot"></a>
            <img src="https://cdn.iconscout.com/icon/free/png-512/free-hamburger-menu-462145.png?f=webp&w=256" class="Menu" onclick="openNav()">
                    <div id="mySidenav" class="sidenav">
                        ...
                        <a href="AvantMatch.php">Les Matchs</a>
    ...
    <Main>
        <div class="content2">
            ...
            <h1 class="Equipe1"><?php echo ucwords(getClubNameById($homeClubId))?> - <?php echo ucwords(getClubNameById($visitorClubId)) ?></h1>
            ...
            <h1 class="Equipe2"><?php echo ucwords(getClubNameById($homeClub2Id))?> - <?php echo ucwords(getClubNameById($visitorClub2Id)) ?></h1>
            <h1 class="Date1">Date : </h1>
            <span class="date3"><?php echo $date2->format('d/m/Y'); ?></span>
            <h1 class="Lieu1">Lieu : </h1>
            <span class="lieu3">test<?php echo ucwords->(htmlspecialchars($MatchRes['stadium_name'])); ?></span>
        </div> 
    </Main>
