...
<head>
    ...
    <link rel="stylesheet" href="AccueilEntraineur.css">
...
<body id="main">
    ...
    <div class="header">
        <div class="icon">
            <a href="http://127.0.0.1:5500/AccueilEntraineur.html"><img src="..\..\..\Ressources Cubes\LogoBloc3.png" class="iconfoot"></a>
            <img src="https://cdn.iconscout.com/icon/free/png-512/free-hamburger-menu-462145.png?f=webp&w=256" class="Menu" onclick="openNav()">
                    <div id="mySidenav" class="sidenav">
                        ...
                        <a href="GererEquipe.php">Gérer mon Equipe</a>
                        <a href="#">Composition Prochain Match</a>
                        <a href="ApresMatch.php">Analyse Derniers Résultats</a>
    ...
    <Main>
        <div class="content2">
            ...
            <button class="Button1"><img src="./assets/club_logo/<?php echo htmlspecialchars($coachClubId); ?>.png"></button>
            <h2 class="Equipe">Gérer mon Equipe</h2>
            <button class="Button2"><img src="https://lepetitlillois.com/wp-content/uploads/2020/04/ligue1-ballon-1536x1024.jpg.webp"></button>
            <h2 class="Matchs">Prochain Match</h2>
            ...
            <h2 class="Resultats">Statistiques</h2>
